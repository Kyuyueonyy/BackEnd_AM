...
public class TodoController {
    ...
    //해야할일 목록 가지고 오기
    //프론트컨트롤러가 부름, 리턴도 프론트컨트롤러에게 view이름을 flxjs
    public String getList(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        //프론트 컨트롤러에게 view 이름을 리턴함
        return "todo/list";
        //프론트 컨트롤러가 이 view이름을 이용해서
        // /views/todo/list.jsp붙여서 호출함.(forward는 프론트 컨트롤러가 다함)
    }

    //상세보기
    public String getView(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        req.setAttribute("info", "나는 상세 정보");
